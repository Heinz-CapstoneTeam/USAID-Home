            ...
            <div id="content">
                <div class="left_content">
                    <div class="content_piece">
                        <h2>Plant: <%= request.getAttribute("search")%>    </h2>
                        <p align="justify" >
                ...
                <div class="right_content">     
                    ...
                    <div class="content_piece">
                        ...
                        <table>
                            ...
                            <tr>
                                <td><b>Family:</b></td>
                                <td><i> <a href="<%= request.getAttribute("familiaURL")%>"> <%= request.getAttribute("familia")%></a></i></td>
                            </tr>
                            <tr>
                                <td><b>Division:</b></td>
                                <td><i> <%= request.getAttribute("divisio")%> </i></td>
                            </tr>
                        </table>
                    <p style="font-size: smaller; font-style: italic;">Source: DBPedia</p>
                    </div>          
